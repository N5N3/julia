...
@testset "Core.Compiler.infer_effects" begin
    ...
    # builtins
    @test Core.Compiler.infer_effects(typeof, Tuple{Any}) |> Core.Compiler.is_foldable_nothrow
    @test Base.return_types() do
        nothing_or_missing(typeof, Tuple{Any}; pred=Core.Compiler.is_foldable_nothrow)
    end |> only === Nothing
    @test Core.Compiler.infer_effects(===, Tuple{Any,Any}) |> Core.Compiler.is_foldable_nothrow
    @test Base.return_types() do
        nothing_or_missing(===, Tuple{Any,Any}; pred=Core.Compiler.is_foldable_nothrow)
    end |> only === Nothing
end
